      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center p-0 md:p-4">
          ...
          <motion.div
            ...
            className={`relative w-full max-w-2xl max-h-[90vh] md:max-h-[85vh] overflow-y-auto rounded-t-[32px] md:rounded-[32px] border-t md:border ${isDark ? 'border-white/10' : 'border-black/10'} ${bg} shadow-2xl no-scrollbar z-10 pb-10 md:pb-0`}
          >
            {/* Mobile Handle */}
                ...
                {!isSuccess ? (
                  ...
                  >
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                      {/* Image Upload */}
                      <div className={`group w-full rounded-[24px] border-2 border-dashed ${isDark ? 'border-white/20 bg-white/5 hover:border-[#c9a227]' : 'border-black/20 bg-black/5 hover:border-[#c9a227]'} p-10 text-center transition-all cursor-pointer relative overflow-hidden`}>
                        <input
                          type="file"
                        ...
                        <div className="flex flex-col items-center justify-center space-y-3">
                          <div className={`rounded-full p-4 transition-transform group-hover:scale-110 ${isDark ? 'bg-white/5 text-white/50' : 'bg-black/5 text-black/50'} group-hover:text-[#c9a227]`}>
                            <Upload size={24} />
                          </div>
                          <div>
                            ...
                            <p className={`text-xs ${isDark ? 'text-white/50' : 'text-black/50'}`}>PNG, JPG up to 10MB</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className={`block text-[10px] font-black uppercase tracking-widest ${isDark ? 'text-white/40' : 'text-black/40'}`}>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full rounded-2xl border pl-12 pr-5 py-4 text-sm outline-none transition-all ${inputBg}`}
                            />
                          </div>
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              value={formData.area}
                              onChange={handleInputChange}
                              className={`w-full rounded-2xl border pl-5 pr-12 py-4 text-sm outline-none transition-all ${inputBg}`}
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            onChange={handleInputChange}
                            className={`w-full rounded-2xl border pl-12 pr-5 py-4 text-sm outline-none transition-all ${inputBg} appearance-none cursor-pointer`}
                          >
                      ...
                      <div className="pt-4">
                        <button
                          ...
                          className="w-full rounded-2xl bg-[#c9a227] px-8 py-5 text-xs font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-[#b08d22] hover:shadow-[0_10px_30px_rgba(201,162,39,0.3)] disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {isSubmitting ? (
                  ...
                  >
                    ...
                    <p className={`text-sm max-w-[300px] leading-relaxed ${isDark ? 'text-white/50' : 'text-black/50'}`}>
