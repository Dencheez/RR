...
const BottomNav = ({ setIsAuthOpen }) => {
    ...
    return (
        <nav
            className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 z-[9999] md:hidden"
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center flex-1 h-full gap-0.5 ${isActive ? "text-[#c9a227]" : "text-gray-500"}`}
                        >
                            {item.isPrimary ? (
                                <div className="bg-[#c9a227] text-white w-11 h-11 flex items-center justify-center rounded-full shadow-lg shadow-[#c9a227]/30 -mt-3">
