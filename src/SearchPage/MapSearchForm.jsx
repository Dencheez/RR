...
export const MapSearchForm =
  ({
    ...
    return (
      ...
      >
        {/* ROW 1: BASIC FILTERS */}
        <div className="flex flex-col md:flex-row md:flex-wrap items-stretch md:items-end gap-6 mb-8">
          {/* Rooms Selection */}
          <div className={groupWrap}>
            <span className={labelClass}>{t('formRooms')}</span>
            <div className={`flex items-center justify-between  md:w-[300px] ${inputBg} p-1 rounded-xl`}>
              {["1", "2", "3", "4", "5+"].map(num => (
                <button
                  key={num}
                  type="button"
          ...
          {/* Basic Checkboxes */}
          <div className="flex items-center gap-6 pb-3 ml-auto grid grid-cols-1 sm:grid-cols-2 md:flex md:flex-row gap-6 w-full">
